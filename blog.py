...
app.config["MYSQL_HOST"] = "mysql host name"
app.config["MYSQL_USER"] = "mysq user"
app.config["MYSQL_PASSWORD"] = "mysqp server password here"
app.config["MYSQL_DB"] = ""
app.config["MYSQL_CURSORCLASS"] = "mysq cursorclass here"
mysql = MySQL(app)
